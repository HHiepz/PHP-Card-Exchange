...
! function(t, e) {
    ...
    var f = function() {
        ...
        w = function() {
            function t(e) {
                a(this, t), this.w = e.w, this.annoCtx = e, this.invertAxis = this.annoCtx.invertAxis, this.helpers = new y(this.annoCtx)
            }
            return r(t, [{
        ...
        k = function() {
            function t(e) {
                a(this, t), this.w = e.w, this.annoCtx = e, this.helpers = new y(this.annoCtx)
            }
            return r(t, [{
        ...
        L = function() {
            function t(e) {
                a(this, t), this.ctx = e, this.w = e.w, this.graphics = new v(this.ctx), this.w.globals.isBarHorizontal && (this.invertAxis = !0), this.helpers = new y(this), this.xAxisAnnotations = new w(this), this.yAxisAnnotations = new k(this), this.pointsAnnotations = new A(this), this.w.globals.isBarHorizontal && this.w.config.yaxis[0].reversed && (this.inversedReversedAxis = !0), this.xDivision = this.w.globals.gridWidth / this.w.globals.dataPoints
            }
            return r(t, [{
        ...
        P = function() {
            ...
            return r(t, [{
                ...
                value: function(t) {
                    ...
                    h.appendChild(c), c.setAttributeNS(window.SVG.xlink, "href", o), v.setAttrs(c, {
                        x: 0,
                        y: 0,
                ...
                value: function(t, e, i, a) {
                    ...
                    if ((o.globals.markers.size[e] > 0 || r || d) && (h = c.group({
                        ...
                        for (var g = 0; g < l.x.length; g++) {
                            ...
                            var x = Array.isArray(o.config.markers.size) ? o.globals.markers.size[e] > 0 : o.config.markers.size > 0;
                            if (x || r || d) {
                                f.isNumber(l.y[g]) ? p += " w".concat(f.randomId()) : p = "apexcharts-nullpoint";
        ...
        M = function() {
            ...
            return r(t, [{
                ...
                value: function(t, e, i, a, s, r, o) {
                    ...
                    if ("circle" === p.shape ? f = u.drawCircle(i) : "square" !== p.shape && "rect" !== p.shape || (f = u.drawRect(0, 0, p.width - p.pointStrokeWidth / 2, p.height - p.pointStrokeWidth / 2, p.pRadius)), n.config.series[l].data[r] && n.config.series[l].data[r].fillColor && (m = n.config.series[l].data[r].fillColor), f.attr({
                    ...
                    if (n.globals.dataChanged && "circle" === p.shape)
                        if (this.dynamicAnim) {
                            ...
                            for (var M = 0; M < n.globals.collapsedSeries.length; M++) n.globals.collapsedSeries[M].index === s && (L = 1, a = 0);
            ...
            return r(t, [{
                ...
                value: function(t, e) {
                    var i = this.w,
                        ...
                        o = e.width,
                        n = e.height,
                        l = new v(this.ctx).drawRect(e.x - s, e.y - r / 2, o + 2 * s, n + r, a.borderRadius, "transparent" === i.config.chart.background ? "#fff" : i.config.chart.background, a.opacity, a.borderWidth, a.borderColor);
        ...
        z = function() {
            ...
            return r(t, [{
                ...
                value: function(t) {
                    ...
                    void 0 !== d && this.barCtx.isRangeBar && (m = d, k = d);
                    var C = A.offsetX,
                        L = A.offsetY,
                        P = {
                            width: 0,
                    ...
                    return y = this.barCtx.isHorizontal ? this.calculateBarsDataLabelsPosition(M) : this.calculateColumnsDataLabelsPosition(M), u.attr({
                        cy: y.bcy,
                        cx: y.bcx,
                        j: o,
                        val: l[r][o],
            ...
            return r(t, [{
                ...
                value: function(t) {
                    ...
                    var u = {
                        ...
                        m = g.move(f, s),
                        y = g.line(x - o, s);
                    return d.globals.previousPaths.length > 0 && (m = this.barCtx.getPreviousPath(l, c, !1)), b = b + g.line(f, p.y2) + p.pathWithRadius + g.line(x - o, p.y2) + y + y + "z", m = m + g.line(f, s) + y + y + y + y + y + g.line(f, s), d.config.chart.stacked && (this.barCtx.yArrj.push(p.y2), this.barCtx.yArrjF.push(Math.abs(s - p.y2)), this.barCtx.yArrjVal.push(this.barCtx.series[h][c])), {
                        pathTo: b,
                        pathFrom: m
                    }
                }
        ...
        Y = function() {
            ...
            return r(t, [{
                    ...
                    for (var n = 0, l = 0; n < t.length; n++, l++) {
                        var h, c, d, g, u = void 0,
                            ...
                            w = s.group({
                                ...
                                rel: n + 1,
                                seriesName: f.escapeString(a.globals.seriesNames[y]),
                                "data:realIndex": y
                            });
                        ...
                        for (var C = s.group({
                            ...
                            z && L.add(z), p = M.y, u = M.x, P > 0 && b.push(u + A / 2), x.push(p);
                        ...
                        a.globals.seriesXvalues[y] = b, a.globals.seriesYvalues[y] = x, o.add(w)
                    }
                    return o
                }
            }, {
                ...
                value: function(t) {
                    ...
                    T.count > 0 && s >= S.globals.dataPoints - T.count && (P.node.setAttribute("stroke-dasharray", T.dashArray), P.node.setAttribute("stroke-width", T.strokeWidth), P.node.setAttribute("fill-opacity", T.fillOpacity)), void 0 !== g && void 0 !== u && (P.attr("data-range-y1", g), P.attr("data-range-y2", u)), new b(this.ctx).setSelectionFilter(P, e, s), h.add(P);
                ...
                value: function(t, i) {
                    ...
                    for (var r = s.group({
                        ...
                        var n, l, h, c = void 0,
                            ...
                            p = s.group({
                                class: "apexcharts-series",
                                seriesName: f.escapeString(a.globals.seriesNames[u]),
                                rel: o + 1,
                                "data:realIndex": u
                            });
                        ...
                        d = m.y, h = m.zeroW, c = m.x, b = m.barWidth, n = m.xDivision, l = m.zeroH;
                        for (var y = s.group({
                                class: "apexcharts-datalabels",
                                "data:realIndex": u
                            }), w = s.group({
        ...
        H = function() {
            ...
            return r(t, [{
                ...
                key: "sparkline",
                value: function(t) {
                    return this.opts.yaxis[0].show = !1, this.opts.yaxis[0].title.text = "", this.opts.yaxis[0].axisBorder.show = !1, this.opts.yaxis[0].axisTicks.show = !1, this.opts.yaxis[0].floating = !0, f.extend(t, {
                        grid: {
                            show: !1,
                            padding: {
                                left: 0,
        ...
        D = function() {
            ...
            return r(t, [{
                ...
                value: function(t) {
                    ...
                    return o = f.extend(h, a), this.handleUserInputErrors(o)
                }
            }, {
        ...
        W = function() {
            function t(e) {
                a(this, t), this.ctx = e, this.w = e.w, this.twoDSeries = [], this.threeDSeries = [], this.twoDSeriesX = [], this.seriesGoals = [], this.coreUtils = new m(this.ctx)
            }
            return r(t, [{
                key: "isMultiFormat",
                value: function() {
        ...
        G = function() {
            ...
            return r(t, [{
                ...
                value: function(t) {
                    if (!f.isIE11()) return t.replace(/&nbsp;/g, "&#160;");
                    var e = 0,
        ...
        j = function() {
            function t(e) {
                a(this, t), this.ctx = e, this.w = e.w;
                var i = this.w;
                this.axesUtils = new V(e), this.xaxisLabels = i.globals.labels.slice(), i.globals.timescaleLabels.length > 0 && !i.globals.isBarHorizontal && (this.xaxisLabels = i.globals.timescaleLabels.slice()), i.config.xaxis.overwriteCategories && (this.xaxisLabels = i.config.xaxis.overwriteCategories), this.drawnLabels = [], this.drawnLabelsRects = [], "top" === i.config.xaxis.position ? this.offY = 0 : this.offY = i.globals.gridHeight + 1, this.offY = this.offY + i.config.xaxis.axisBorder.offsetY, this.isCategoryBarHorizontal = "bar" === i.config.chart.type && i.config.plotOptions.bar.horizontal, this.xaxisFontSize = i.config.xaxis.labels.style.fontSize, this.xaxisFontFamily = i.config.xaxis.labels.style.fontFamily, this.xaxisForeColors = i.config.xaxis.labels.style.colors, this.xaxisBorderWidth = i.config.xaxis.axisBorder.width, this.isCategoryBarHorizontal && (this.xaxisBorderWidth = i.config.yaxis[0].axisBorder.width.toString()), this.xaxisBorderWidth.indexOf("%") > -1 ? this.xaxisBorderWidth = i.globals.gridWidth * parseInt(this.xaxisBorderWidth, 10) / 100 : this.xaxisBorderWidth = parseInt(this.xaxisBorderWidth, 10), this.xaxisBorderHeight = i.config.xaxis.axisBorder.height, this.yaxis = i.config.yaxis[0]
            }
            return r(t, [{
                key: "drawXaxis",
                value: function() {
                ...
                value: function(t) {
                    ...
                    if (m.show) {
                        var y = r.drawLine(s.globals.padHorizontal + m.offsetX + b, 1 + m.offsetY, s.globals.padHorizontal + m.offsetX + b, s.globals.gridHeight + m.offsetY, m.color, 0);
                        n.add(y)
                    }
                ...
                value: function(t, e, i) {
                    ...
                    if (!(t < 0 || t - 2 > a.globals.gridWidth)) {
                        ...
                        if (e = e + r + a.config.xaxis.axisTicks.height, "top" === a.config.xaxis.position && (e = r - a.config.xaxis.axisTicks.height), a.config.xaxis.axisTicks.show) {
                            var o = new v(this.ctx).drawLine(t + a.config.xaxis.axisTicks.offsetX, r + a.config.xaxis.offsetY, s + a.config.xaxis.axisTicks.offsetX, e + a.config.xaxis.offsetY, a.config.xaxis.axisTicks.color);
        ...
        _ = function() {
            function t(e) {
                a(this, t), this.ctx = e, this.w = e.w;
                var i = this.w;
                this.xaxisLabels = i.globals.labels.slice(), this.axesUtils = new V(e), this.isRangeBar = i.globals.seriesRangeBar.length, i.globals.timescaleLabels.length > 0 && (this.xaxisLabels = i.globals.timescaleLabels.slice())
            }
            return r(t, [{
                key: "drawGridArea",
                value: function() {
                ...
                value: function(t) {
                    ...
                    if (!(0 === e && l.globals.skipFirstTimelinelabel || e === o - 1 && l.globals.skipLastTimelinelabel && !l.config.xaxis.labels.formatter || "radar" === l.config.chart.type)) {
                        ...
                        new j(this.ctx).drawXaxisTicks(i, h, this.elg)
                    }
                }
            }, {
                key: "_drawGridLine",
                value: function(t) {
                    var e = t.x1,
                        ...
                        c = new v(this).drawLine(e - (n ? h : 0), i, a + (n ? h : 0), s, o.config.grid.borderColor, l);
                ...
                value: function(t) {
                    ...
                    if (i.config.grid.xaxis.lines.show || i.config.xaxis.axisTicks.show)
                        ...
                        }), new j(this.ctx).drawXaxisTicks(s, 0, this.elg), a = s = s + i.globals.gridWidth / e + .3;
        ...
        Z = function() {
            function t(e) {
                a(this, t), this.ctx = e, this.w = e.w;
                var i = this.w;
                this.xaxisFontSize = i.config.xaxis.labels.style.fontSize, this.axisFontFamily = i.config.xaxis.labels.style.fontFamily, this.xaxisForeColors = i.config.xaxis.labels.style.colors, this.isCategoryBarHorizontal = "bar" === i.config.chart.type && i.config.plotOptions.bar.horizontal, this.xAxisoffX = 0, "bottom" === i.config.xaxis.position && (this.xAxisoffX = i.globals.gridHeight), this.drawnLabels = [], this.axesUtils = new V(e)
            }
            return r(t, [{
                key: "drawYaxis",
                value: function(t) {
        ...
        $ = function() {
            function t(e) {
                a(this, t), this.ctx = e, this.w = e.w, this.documentEvent = f.bind(this.documentEvent, this)
            }
            return r(t, [{
                    ...
                    if (0 !== a.responsive.length) {
                        ...
                        var r = new D({}),
                            o = function() {
                                ...
                                if (o > a) {
                                    var n = m.extendArrayProps(r, i.globals.initialConfig, i);
                                    t = f.extend(n, t), t = f.extend(i.config, t), e.overrideResponsiveOptions(t)
                                } else
                                    for (var l = 0; l < s.length; l++) o < s[l].breakpoint && (t = m.extendArrayProps(r, s[l].options, i), t = f.extend(i.config, t), e.overrideResponsiveOptions(t))
                            };
                        if (t) {
                            var n = m.extendArrayProps(r, t, i);
                ...
                value: function() {
                    ...
                    return e.config.yaxis.map((function(r, o) {
                        ...
                        if (!s.isYAxisHidden(o) && r.labels.show && void 0 !== r.labels.minWidth && (l = r.labels.minWidth), !s.isYAxisHidden(o) && r.labels.show && n.result.length) {
                            ...
                            var x = new v(t.dCtx.ctx),
                                b = "rotate(".concat(r.labels.rotate, " 0 0)"),
                                m = x.getTextRects(g, r.labels.style.fontSize, r.labels.style.fontFamily, b, !1),
                                y = m;
                            g !== u && (y = x.getTextRects(u, r.labels.style.fontSize, r.labels.style.fontFamily, b, !1)), i.push({
            ...
            return r(t, [{
                ...
                value: function() {
                    ...
                    for (var o = e.globals.legendFormatter, n = e.config.legend.inverseOrder, l = n ? a.length - 1 : 0; n ? l >= 0 : l <= a.length - 1; n ? l-- : l++) {
                        ...
                        T || (T = e.config.chart.foreColor), P.style.color = T, P.style.fontSize = parseFloat(e.config.legend.fontSize) + "px", P.style.fontWeight = e.config.legend.fontWeight, P.style.fontFamily = i || e.config.chart.fontFamily, v.setAttrs(P, {
                            rel: l + 1,
                            i: l,
                ...
                value: function(t, e) {
                    ...
                    if (void 0 !== t || void 0 !== e) {
                        if (!(i.config.xaxis.convertedCatToNumeric && (t < 1 && (t = 1, e = i.globals.dataPoints), e - t < 2))) {
                            ...
                            i.config.chart.zoom.autoScaleYaxis && (o = new U(this.ctx).autoScaleY(this.ctx, o, {
                                xaxis: a
        ...
        dt = function(t) {
            ...
            function i(t) {
                var s;
                return a(this, i), (s = e.call(this, t)).ctx = t, s.w = t.w, s.dragged = !1, s.graphics = new v(s.ctx), s.eventList = ["mousedown", "mouseleave", "mousemove", "touchstart", "touchmove", "mouseup", "touchend"], s.clientX = 0, s.clientY = 0, s.startX = 0, s.endX = 0, s.dragX = 0, s.startY = 0, s.endY = 0, s.dragY = 0, s.moveDirection = "none", s
            }
            return r(i, [{
                key: "init",
                value: function(t) {
        ...
        gt = function() {
            ...
            return r(t, [{
                ...
                value: function(t) {
                    ...
                    return r.globals.capturedSeriesIndex = null === b ? -1 : b, (!p || p < 1) && (p = 0), r.globals.isBarHorizontal ? r.globals.capturedDataPointIndex = x : r.globals.capturedDataPointIndex = p, {
                        capturedSeries: b,
        ...
        mt = function(t) {
            ...
            return r(s, [{
                ...
                value: function(t, i) {
                    var a = this,
                        s = this.w;
                    this.graphics = new v(this.ctx), this.bar = new Y(this.ctx, this.xyRatios);
                    var r = new m(this.ctx, s);
                    ...
                    for (var n = this.graphics.group({
                            ...
                            for (var A = 0; A < s.globals.dataPoints; A++) {
                                ...
                                a.isHorizontal ? (L = a.drawStackedBarPaths(e(e({}, C), {}, {
                                    ...
                                    barWidth: w,
                                    zeroH: g
                                })), y = a.series[r][A] / a.yRatio[a.yaxisIndex]), h = L.y, l = L.x, p.push(l), x.push(h);
                            ...
                            s.globals.seriesXvalues[b] = p, s.globals.seriesYvalues[b] = x, a.prevY.push(a.yArrj), a.prevYF.push(a.yArrjF), a.prevYVal.push(a.yArrjVal), a.prevX.push(a.xArrj), a.prevXF.push(a.xArrjF), a.prevXVal.push(a.xArrjVal), n.add(v)
        ...
        yt = function(t) {
            ...
            return r(s, [{
                ...
                value: function(t, i) {
                    ...
                    for (var l = r.group({
                            ...
                            var h, c, d, g, u, p, x = void 0,
                                ...
                                w = r.group({
                                    class: "apexcharts-series",
                                    seriesName: f.escapeString(s.globals.seriesNames[y]),
                                    rel: n + 1,
                                    "data:realIndex": y
                                });
                            ...
                            b = k.y, u = k.barHeight, c = k.yDivision, g = k.zeroW, x = k.x, p = k.barWidth, h = k.xDivision, d = k.zeroH, m.push(x + p / 2);
                            for (var A = r.group({
                                    class: "apexcharts-datalabels",
                                    "data:realIndex": y
                                }), S = function(i) {
                                    ...
                                    l = a.isHorizontal ? a.drawHorizontalBoxPaths(e(e({}, f), {}, {
                                        yDivision: c,
                                        barHeight: u,
                                        zeroW: g
                                    })) : a.drawVerticalBoxPaths(e(e({}, f), {}, {
                                        xDivision: h,
                                        barWidth: p,
                                        zeroH: d
                                    })), b = l.y, x = l.x, i > 0 && m.push(x + p / 2), v.push(b), l.pathTo.forEach((function(e, h) {
                ...
                value: function(t) {
                    ...
                    void 0 === this.series[h][c] || null === this.series[h][c] ? (w = r, k = r) : (w = r - w / f, k = r - k / f, m = r - b.h / f, y = r - b.l / f, A = r - b.m / f);
                    var C = l.move(S, r),
                        L = l.move(S + s / 2, w);
                ...
                value: function(t) {
                    ...
                    void 0 === this.series[h][c] || null === this.series[h][c] ? (b = r, m = r) : (b = r + b / g, m = r + m / g, f = r + p.h / g, x = r + p.l / g, y = r + p.m / g);
                    var k = l.move(r, w),
                        A = l.move(b, w + s / 2);
                    ...
                    for (var h = n ? 0 : l.length - 1; n ? h < l.length : h >= 0; n ? h++ : h--) {
                        ...
                        for (var g = 0, u = e.config.plotOptions.heatmap.shadeIntensity, p = 0; p < l[h].length; p++) {
                            var x = this.helpers.getShadeColor(e.config.chart.type, h, p, this.negRange),
                                m = x.color,
                                y = x.colorProps;
                            "image" === e.config.fill.type && (m = new P(this.ctx).fillPath({
                                seriesNumber: h,
                                dataPointIndex: p,
            ...
            return r(t, [{
                ...
                value: function(t, e) {
                    ...
                    for (var d = 0; d < t.length; d++) {
                        ...
                        this.addListeners(m, this.donutDataLabels), v.setAttrs(m.node, {
                            "data:angle": u,
                            "data:startAngle": n,
        ...
        Ct = function() {
            function t(e) {
                ...
                var i = this.w;
                this.graphics = new v(this.ctx), this.lineColorArr = void 0 !== i.globals.stroke.colors ? i.globals.stroke.colors : i.globals.colors, this.defaultSize = i.globals.svgHeight < i.globals.svgWidth ? i.globals.gridHeight + 1.5 * i.globals.goldenPadding : i.globals.gridWidth, this.isLog = i.config.yaxis[0].logarithmic, this.coreUtils = new m(this.ctx), this.maxValue = this.isLog ? this.coreUtils.getLogVal(i.globals.maxY, 0) : i.globals.maxY, this.minValue = this.isLog ? this.coreUtils.getLogVal(this.w.globals.minY, 0) : i.globals.minY, this.polygons = i.config.plotOptions.radar.polygons, this.strokeWidth = i.config.stroke.show ? i.config.stroke.width : 0, this.size = this.defaultSize / 2.1 - this.strokeWidth - i.config.chart.dropShadow.blur, i.config.xaxis.labels.show && (this.size = this.size - i.globals.xAxisLabelsWidth / 1.75), void 0 !== i.config.plotOptions.radar.size && (this.size = i.config.plotOptions.radar.size), this.dataRadiusOfPercent = [], this.dataRadius = [], this.angleArr = [], this.yaxisLabelsTextsPos = []
            }
            return r(t, [{
                key: "draw",
                value: function(t) {
                    ...
                    if (this.yaxisLabels = this.graphics.group({
                            ...
                            var l = t.length === a.globals.dataPoints,
                                h = i.graphics.group().attr({
                                    ...
                                    seriesName: f.escapeString(a.globals.seriesNames[n]),
                                    rel: n + 1,
                                    "data:realIndex": n
                                });
                            ...
                            var d = {
                                ...
                                x = null;
                            a.globals.previousPaths.length > 0 && (x = i.getPreviousPath(n));
                            for (var v = 0; v < c.linePathsTo.length; v++) {
                                var m = i.graphics.renderPaths(e(e({}, d), {}, {
                                    pathFrom: null === x ? c.linePathsFrom[v] : x,
                                ...
                                var y = s.fillPath({
                                    ...
                                    w = i.graphics.renderPaths(e(e({}, d), {}, {
                                        pathFrom: null === x ? c.areaPathsFrom[v] : x,
                ...
                value: function() {
                    var t = this,
                        ...
                        r = f.getPolygonPos(this.size, this.dataPointsLen);
                ...
                value: function(t) {
                    ...
                    for (var x = p ? t.series.length - 1 : 0; p ? x >= 0 : x < t.series.length; p ? x-- : x++) {
                        var m = i.group({
                            ...
                            seriesName: f.escapeString(e.globals.seriesNames[x])
                        });
                        r.add(m), m.attr({
                            rel: x + 1,
                            "data:realIndex": x
                        }), this.ctx.series.addCollapsedClassToSeries(m, x), t.size = t.size - o - this.margin;
                        var y = a.fillPath({
                                seriesNumber: x,
                                size: t.size,
                                value: t.series[x]
                            ...
                            w = this.startAngle,
                            k = void 0,
                            A = f.negToZero(t.series[x] > 100 ? 100 : t.series[x]) / 100,
                            S = Math.round(this.totalAngle * A) + this.startAngle,
                            C = void 0;
                        e.globals.dataChanged && (k = this.startAngle, C = Math.round(this.totalAngle * f.negToZero(e.globals.previousPaths[x]) / 100) + k), Math.abs(S) + Math.abs(w) >= 360 && (S -= .01), Math.abs(C) + Math.abs(k) >= 360 && (C -= .01);
                        var L = S - w,
                            T = Array.isArray(e.config.stroke.dashArray) ? e.config.stroke.dashArray[x] : e.config.stroke.dashArray,
                            M = i.drawPath({
                                d: "",
                                stroke: y,
                                strokeWidth: o,
                        ...
                        s.setSelectionFilter(M, 0, x), this.addListeners(M, this.radialDataLabels), m.add(M), M.attr({
                            index: 0,
                            j: x
                        });
                        var z = 0;
        ...
        Tt = function() {
            ...
            return r(t, [{
                ...
                value: function(t) {
                    for (var e = t.series, i = t.realIndex, a = t.i, s = t.x, r = t.y, o = t.pX, n = t.pY, l = t.pathsFrom, h = t.linePaths, c = t.areaPaths, d = t.seriesIndex, g = t.lineYPosition, u = t.xArrj, p = t.yArrj, x = this.w, b = new v(this.ctx), m = this.yRatio, y = l.prevY, w = l.linePath, k = l.areaPath, A = l.pathFromLine, S = l.pathFromArea, C = f.isNumber(x.globals.minYArr[i]) ? x.globals.minYArr[i] : x.globals.minY, L = x.globals.dataPoints > 1 ? x.globals.dataPoints - 1 : x.globals.dataPoints, P = 0; P < L; P++) {
                        ...
                        g = x.config.chart.stacked && a > 0 && x.globals.collapsedSeries.length < x.config.series.length - 1 ? this.prevSeriesY[function(t) {
                            ...
                            return e >= 0 ? e : 0
                        }(a - 1)][P + 1] : this.zeroY, r = T ? g - C / m[this.yaxisIndex] + 2 * (this.isReversed ? C / m[this.yaxisIndex] : 0) : g - e[a][P + 1] / m[this.yaxisIndex] + 2 * (this.isReversed ? e[a][P + 1] / m[this.yaxisIndex] : 0), u.push(s), p.push(r);
            ...
            return r(t, [{
                ...
                value: function(t) {
                    ...
                    for (var v = g, m = 0; m < o; m++) {
                        l = "hour", p >= 24 && (p = 0, l = "day", b = h(x += 1, b).month, b = c(x, b));
        ...
        Et = function() {
            ...
            return r(t, [{
                ...
                value: function(t, e) {
                    ...
                    if (s.comboCharts) {
                        if (o.series.length > 0 && x.push(g.draw(o.series, "area", o.i)), h.series.length > 0)
                            ...
                            } else this.ctx.bar = new Y(this.ctx, e), x.push(this.ctx.bar.draw(h.series, h.i));
                        ...
                        case "area":
                            ...
                            break;
                        case "bar":
                            a.chart.stacked ? x = new mt(this.ctx, e).draw(s.series) : (this.ctx.bar = new Y(this.ctx, e), x = this.ctx.bar.draw(s.series));
                            break;
                        case "candlestick":
                        case "boxPlot":
                ...
                value: function() {
                    ...
                    if (t.svgWidth < 0 && (t.svgWidth = 0), t.svgHeight < 0 && (t.svgHeight = 0), v.setAttrs(t.dom.Paper.node, {
                            width: t.svgWidth,
                            height: t.svgHeight
                        }), "%" !== s) {
                ...
                value: function(t, e) {
                    ...
                    return new Promise((function(s) {
                        ...
                        return o.globals.shouldAnimate = e, o.globals.dataChanged = !0, e && i.ctx.series.getPreviousPaths(), o.globals.axisCharts ? (0 === (r = t.map((function(t, e) {
                            ...
                            data: []
                        }]), o.config.series = r) : o.config.series = t.slice(), a && (o.globals.initialSeries = f.clone(o.config.series)), i.ctx.update().then((function() {
                            s(i.ctx)
                        }))
                    }))
                }
    ...
    Mt = "undefined" != typeof window ? window : void 0, It = function(t, e) {
            ...
            return It(Mt, Mt.document)
        })) : "object" === ("undefined" == typeof exports ? "undefined" : i(exports)) && "undefined" != typeof module ? module.exports = Mt.document ? It(Mt, Mt.document) : function(t) {
            return It(t, t.document)
        } : Mt.SVG = It(Mt, Mt.document),
        ...
        return r(t, [{
            ...
            value: function() {
                ...
                return new Promise((function(s, r) {
                    ...
                    i.annotations = new L(i), i.annotations.drawImageAnnos(), i.annotations.drawTextAnnos(), "back" === a.config.grid.position && o && a.globals.dom.elGraphical.add(o.el);
                    var n = new j(t.ctx),
                        l = new Z(t.ctx);
            ...
            value: function() {
                ...
                i && Apex._chartInstances.forEach((function(t, e) {
                    t.id === f.escapeString(i) && Apex._chartInstances.splice(e, 1)
