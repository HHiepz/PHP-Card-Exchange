...
<div class="scroll-to-top">
    <button type="button" class="btn btn-primary btn-icon-only rounded-circle hp-primary-shadow">
        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="16px" width="16px" xmlns="http://www.w3.org/20/svg">
            <g>
...
<!-- Charts -->
<script src="<?= getDomain() ?>/frontend/app-assets/js/plugin/apexcharts.min.js"></script>
<script src="<?= getDomain() ?>/frontend/app-assets/js/charts/apex-chart.js"></script>

<!-- Cards -->
<script src="<?= getDomain() ?>/frontend/app-assets/js/cards/card-analytic.js"></script>
<script src="<?= getDomain() ?>/frontend/app-assets/js/cards/card-advance.js"></script>
<script src="<?= getDomain() ?>/frontend/app-assets/js/cards/card-statistic.js"></script>

<!-- Custom -->
<script src="<?= getDomain() ?>/frontend/assets/js/main.js"></script>
</body>
